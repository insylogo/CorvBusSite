...
namespace CorvallisTransit.Models
{
    ...
    public partial class RoutePosition
    {
        ...
        {
            return Items.Length > 1 ? Items.Skip(1).Select(i => i as RoutePositionPlatform).FirstOrDefault(s => s.Route != null && s.Route.Any(r => r.RouteNo == stop.RouteModel.RouteNo)) : null;
        }
    }
}